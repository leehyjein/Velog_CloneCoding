        ...
        <>
            <HeaderWrap>
                <div>
                    <Grid flex width='max-content'>
                        <svg width="71" height="24" viewBox="0 0 71 24" fill="none" data-testid="velog-logo">
                    ...
                    {/* <Grid flex align='center' ps='relative' width='max-content'>
                        <Button headerL>새 글 작성</Button>
                        <div className='user_info_now' onClick={()=>{!user_nav ? setUserNav(true) : setUserNav(false)}}>
                            <img src="https://t1.daumcdn.net/cfile/tistory/990FFC345F9FAC2316" alt="유저 프로필 이미지" />
            ...
            {login_modal && (
                <>
                    ...
                    <SignInUp _class={fade_out ? 'fade_out' : '' }>
